...
public class Shearing_YAxis3D_BgLibrary {
	public void BGHehe() {
		...
		double[][] BGMatrix = BGhelper3DLibrary.BGShearingYMatrix(a, c);
		...
		BGhelperPackage3D.createFrame("3D Shearing Along Y-Axis - Library Function With Bikram", AshliPanel);
	}

	public static void main(String[] args) {
		new Shearing_YAxis3D_BgLibrary().BGHehe();
	}
}