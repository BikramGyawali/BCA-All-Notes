...
public class Rotation_XAxis3D_BgLibrary {
	public void BGHehe() {
		...
		double[][] BGMatrix = BGhelper3DLibrary.BGRotationXMatrix(BGAngle);
		...
		BGhelperPackage3D.createFrame(
				"3D Rotation Along X-Axis - Library Function ",
				AshliPanel);
	}

	public static void main(String[] args) {
		new Rotation_XAxis3D_BgLibrary().BGHehe();
	}
}