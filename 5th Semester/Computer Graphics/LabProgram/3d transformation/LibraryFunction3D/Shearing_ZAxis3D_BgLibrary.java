...
public class Shearing_ZAxis3D_BgLibrary {
	public void BGHehe() {
		...
		double[][] BGMatrix = BGhelper3DLibrary.BGShearingZMatrix(a, b);
		...
		BGhelperPackage3D.createFrame("3D Shearing Along Z-Axis - Library Function With Bikram", AshliPanel);
	}

	public static void main(String[] args) {
		new Shearing_ZAxis3D_BgLibrary().BGHehe();
	}
}