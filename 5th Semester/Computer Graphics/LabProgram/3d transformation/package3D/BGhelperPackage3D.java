...
public class BGhelperPackage3D {
    ...
    public static class CustomPanel3D extends JPanel {
        ...
        public void BGDrawAxes(Graphics2D g2) {
            ...
            g2.drawString("X-Axis",getWidth()-60,centerY-10);

            g2.drawLine(centerX,0,centerX,getHeight());
            g2.drawString("Y-Axis",centerX+10,25);
        ...
        public void BGDrawCube(
            Graphics2D g2,
            double[][] BGPoint,
            Color BGColor,
            boolean BGIsTransformed
        ) {
            int[][] BGEdge={
                {0,1},{1,2},{2,3},{3,0},
                {4,5},{5,6},{6,7},{7,4},
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2.drawString(
                "Transformed Cube: A',B',C',D',E',F',G',H'",
                20,
                55
            );
        }
