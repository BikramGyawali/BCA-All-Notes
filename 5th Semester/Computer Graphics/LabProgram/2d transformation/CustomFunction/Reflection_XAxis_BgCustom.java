...
public class Reflection_XAxis_BgCustom {
	...
	public void BGHehe() {
		...
		BGhelperPackage.createFrame("Reflection Along X-Axis - Custom Function", AshliPanel);
	}
	...
	public static void main(String[] args) {
		new Reflection_XAxis_BgCustom().BGHehe();
	}
}
