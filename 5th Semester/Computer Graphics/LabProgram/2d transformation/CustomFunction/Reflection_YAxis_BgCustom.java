...
public class Reflection_YAxis_BgCustom {
	public void BGHehe() {
		...
		BGhelperPackage.createFrame("Reflection Along Y-Axis - Custom Function With Bikram", AshliPanel);
	}
	...
	public static void main(String[] args) {
		new Reflection_YAxis_BgCustom().BGHehe();
	}
}
