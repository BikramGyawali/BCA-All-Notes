...
public class ClockwiseRotation_BgLibrary {
	public void BGHehe() {
		Scanner sa = new Scanner(System.in);
		BGhelperPackage bg = new BGhelperPackage();
		bg.inputCoordinate(sa);
		System.out.print("\nEnter Clockwise Rotation Angle : ");
		...
		BGhelperPackage.createFrame("Clockwise Rotation - Library Function With Bikram ", AshliPanel);
	}

	public static void main(String[] args) {
		new ClockwiseRotation_BgLibrary().BGHehe();
	}
}
