...
public class Shearing_YAxis_BgLibrary {
	public void BGHehe() {
		...
		AffineTransform BGTransform = AffineTransform.getShearInstance(0, Shy);
		...
		BGhelperPackage.createFrame("Shearing Along Y-Axis - Library Function With Bikram", AshliPanel);
	}

	public static void main(String[] args) {
		new Shearing_YAxis_BgLibrary().BGHehe();
	}
}
