...
public class Reflection_YequalsX_BgLibrary {
	public void BGHehe() {
		Scanner sa = new Scanner(System.in);
		BGhelperPackage bg = new BGhelperPackage();
		bg.inputCoordinate(sa);
		AffineTransform BGTransform = new AffineTransform(0, 1, 1, 0, 0, 0);
		...
		BGhelperPackage.createFrame("Reflection Along y = x - Library Function With Bikram", AshliPanel);
	}

	public static void main(String[] args) {
		new Reflection_YequalsX_BgLibrary().BGHehe();
	}
}
