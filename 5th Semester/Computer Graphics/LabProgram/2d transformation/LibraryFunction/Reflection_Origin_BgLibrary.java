...
public class Reflection_Origin_BgLibrary {
	public void BGHehe() {
		Scanner sa = new Scanner(System.in);
		BGhelperPackage bg = new BGhelperPackage();
		bg.inputCoordinate(sa);

		AffineTransform BGTransform = AffineTransform.getScaleInstance(-1, -1);
		...
		BGhelperPackage.createFrame("Reflection Along Origin - Library Function With Bikram", AshliPanel);
	}

	public static void main(String[] args) {
		new Reflection_Origin_BgLibrary().BGHehe();
	}
