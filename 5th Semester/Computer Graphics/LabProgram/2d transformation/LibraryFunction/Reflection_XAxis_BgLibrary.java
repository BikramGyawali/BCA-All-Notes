...
public class Reflection_XAxis_BgLibrary {
public void BGHehe() {
...
bg.inputCoordinate(sa);
    ...
    BGhelperPackage.createFrame("Reflection Along X-Axis - Library Function With Bikram", AshliPanel);
}

public static void main(String[] args) {
    new Reflection_XAxis_BgLibrary().BGHehe();
}
}
