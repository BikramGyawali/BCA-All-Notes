...
public class Reflection_YAxis_BgLibrary {
	public void BGHehe() {
		...
		BGhelperPackage.createFrame("Reflection Along Y-Axis - Library Function", AshliPanel);
	}

	public static void main(String[] args) {
		new Reflection_YAxis_BgLibrary().BGHehe();
	}
}
