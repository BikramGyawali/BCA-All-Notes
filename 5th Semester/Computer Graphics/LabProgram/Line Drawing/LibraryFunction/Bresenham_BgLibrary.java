...
public class Bresenham_BgLibrary {
	public void BGHehe() {
		...
		BGhelperPackageLine.createFrame("Bresenham Line Drawing - Library Function With Bikram", AshliPanel);
	}

	public static void main(String[] args) {
		new Bresenham_BgLibrary().BGHehe();
	}
}