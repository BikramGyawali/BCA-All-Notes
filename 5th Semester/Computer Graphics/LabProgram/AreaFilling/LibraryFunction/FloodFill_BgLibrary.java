...
public class FloodFill_BgLibrary {
	public static void main(String[] args) {
		Scanner bikram = new Scanner(System.in);
		int canvasWidth = 600;
		int canvasHeight = 450;
		System.out.println(" Library Flood Fill With Bikram");
		...
		System.out.println("Library Fill Color: GREEN");
		BGAreaFilling.showImage(butwal, "Bikram - Library Flood Fill");
		bikram.close();
	}
}
